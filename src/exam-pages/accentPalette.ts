...
export const accentPalettes: Record<AccentId, AccentPalette> = {
  amber: {
    ...
    dataOpenBg: 'data-[state=open]:bg-amber-500/[0.04]',
  ...
  teal: {
    ...
    dataOpenBg: 'data-[state=open]:bg-teal-500/[0.04]',
  ...
  cyan: {
    ...
    dataOpenBg: 'data-[state=open]:bg-cyan-500/[0.04]',
  ...
  emerald: {
    ...
    dataOpenBg: 'data-[state=open]:bg-emerald-500/[0.04]',
  ...
  blue: {
    ...
    dataOpenBg: 'data-[state=open]:bg-blue-500/[0.04]',
  ...
  rose: {
    ...
    dataOpenBg: 'data-[state=open]:bg-rose-500/[0.04]',
  ...
  indigo: {
    ...
    dataOpenBg: 'data-[state=open]:bg-indigo-500/[0.04]',
  ...
  orange: {
    ...
    dataOpenBg: 'data-[state=open]:bg-orange-500/[0.04]',
  ...
  violet: {
    ...
    dataOpenBg: 'data-[state=open]:bg-violet-500/[0.04]',
