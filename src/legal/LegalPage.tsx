...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      'Cookies & analytics: we use a cookie-consent banner so you can accept or decline non-essential cookies. Where enabled, we use Plausible for basic, privacy-focused traffic analytics.',
