...
import { type CalculateDailyStats as CalculateDailyStatsJob } from 'wasp/server/jobs';
...
export const calculateDailyStats: CalculateDailyStatsJob<never, void> = async (_args, context) => {
