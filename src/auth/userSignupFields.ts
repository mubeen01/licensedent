...
// Trimmed + lowercased so " A@X.com ,b@x.com" style env values can't bypass
// or break matching. Email comparison must be case-insensitive here or an
// admin signing up with different casing silently loses the admin role.
